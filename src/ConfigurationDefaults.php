...
class ConfigurationDefaults
{
    ...
    public const ENVIRONMENT = Environment::PAPER;

    public const APCA_API_KEY_ID = '';

    public const APCA_API_SECRET_KEY = '';
    ...
    public const _ALL = [
        ...
        'apcaApiKeyId' => self::APCA_API_KEY_ID,
        'apcaApiSecretKey' => self::APCA_API_SECRET_KEY,
