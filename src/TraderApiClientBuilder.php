...
class TraderApiClientBuilder
{
    ...
    public function apiSecretCredentials(ApiSecretCredentialsBuilder $apiSecret): self
    {
        $this->config = array_merge($this->config, $apiSecret->getConfiguration());
        return $this;
    }
    ...
    public function build(): TraderApiClient
    {
        return new TraderApiClient($this->config);
    }
}
